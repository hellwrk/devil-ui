...
- Updated dependencies [36fc155]
  - @hellwrk/devil-ui@2.13.2

## 1.5.20

### Patch Changes

- Updated dependencies [7d5241d]
  - @hellwrk/devil-ui@2.13.1
...
- Updated dependencies [1ede8bf]
- Updated dependencies [8482c50]
- Updated dependencies [7526a6a]
- Updated dependencies [b094a5a]
- Updated dependencies [20b7880]
  - @hellwrk/devil-ui@2.13.0
...
- 11e62a2: # Kumo 1.0.0 Release
  ...
  Blocks (`PageHeader`, `ResourceListPage`) are no longer exported from `@hellwrk/devil-ui`. They must now be installed via the CLI:

  ```bash
  npx @hellwrk/devil-ui init        # Initialize kumo.json
  npx @hellwrk/devil-ui add PageHeader
  ```

  Blocks are copied to your project for full customization with imports automatically transformed to `@hellwrk/devil-ui`.
...
- Updated dependencies [7d4a4e0]
  - @hellwrk/devil-ui@1.0.0

## 0.5.0

### Minor Changes

- d04c91f: Ship component registry with @hellwrk/devil-ui module
