...
## Installation
  ...
  <div class="space-y-4">
    <div>
      <p>**1. Initialize Devil config (first time only)**</p>
...
```tsx
// The path depends on your devil-ui.json blocksDir setting
// Default: src/components/devil-ui/
import { ResourceListPage } from "./components/devil-ui/resource-list/resource-list";
```
...
```tsx
import { ResourceListPage } from "./components/devil-ui/resource-list/resource-list";
import { Surface } from "@hellwrk/devil-ui";
...
export default function DatabasesPage() {
  return (
    <ResourceListPage
      ...
      icon={<DatabaseIcon size={32} className="text-devil-strong" />}
    >
