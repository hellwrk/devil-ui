...
import {
  ...
  PoweredByCloudflare,
  generateCloudflareLogoSvg,
} from "@hellwrk/devil-ui/components/cloudflare-logo";
```
...
```tsx
import { CloudflareLogo } from "@hellwrk/devil-ui";
...
```tsx
import { generateCloudflareLogoSvg } from "@hellwrk/devil-ui";
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-left text-sm">
      ...
      <tbody class="text-devil-subtle">
        ...
        <tr class="border-b border-devil-hairline">
          <td class="py-3 pr-4 font-mono text-devil-default">color</td>
        ...
        <tr>
          <td class="py-3 pr-4 font-mono text-devil-default">className</td>
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-left text-sm">
      ...
      <tbody class="text-devil-subtle">
        ...
        <tr>
          <td class="py-3 pr-4 font-mono text-devil-default">href</td>
          <td class="py-3 pr-4 font-mono">string</td>
