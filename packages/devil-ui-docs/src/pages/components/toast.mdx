...
```tsx
import { Toasty, useDevilToastManager } from "@hellwrk/devil-ui";
```

### Granular

```tsx
import { Toasty, useDevilToastManager } from "@hellwrk/devil-ui/components/toast";
```
...
## Usage
  ...
  <p>
    The toast system consists of two parts: the `Toasty` provider component and the `useDevilToastManager()` hook for triggering toasts.
  </p>

```tsx
import { Toasty, useDevilToastManager, Button } from "@hellwrk/devil-ui";
...
import { Toasty } from "@hellwrk/devil-ui";
...
<div class="overflow-x-auto">
  <table class="w-full text-left text-sm">
    ...
    <tbody class="text-devil-subtle">
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">title</td>
        <td class="py-3 pr-4 font-mono">string</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">The toast title displayed prominently.</td>
      </tr>
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">description</td>
        <td class="py-3 pr-4 font-mono">string</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">Secondary text displayed below the title.</td>
      </tr>
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">variant</td>
      ...
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">content</td>
      ...
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">actions</td>
        <td class="py-3 pr-4 font-mono">ButtonProps[]</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">Array of button props to render as action buttons.</td>
      </tr>
      <tr class="border-b border-devil-hairline">
        <td class="py-3 pr-4 font-mono text-devil-default">timeout</td>
