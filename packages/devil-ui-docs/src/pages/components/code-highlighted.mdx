...
<ComponentSection>
  <div class="mb-4 rounded-md border border-devil-brand/20 bg-devil-brand/5 p-4">
    <p class="text-sm text-devil-strong">
      <strong>New in v1.10:</strong> Shiki-powered syntax highlighting with lazy
      loading. Import from `devil-ui/code` to use.
    </p>
  </div>
...
## Overview
  ...
  <p>
    ...
    entry point ( `devil-ui/code` ) to avoid bundling Shiki for apps
    that don't need it.
  </p>
</ComponentSection>
...
```
  ...
  <div class="mt-4 rounded-md border border-devil-warning/20 bg-devil-warning/5 p-4">
    <p class="text-sm text-devil-strong">
      <strong>Important:</strong> Do NOT import from the main `devil-ui` entry.
...
<p>
  Customize the highlight color with the `--devil-code-highlight-bg` CSS
  variable.
</p>
...
## Themes
  ...
  <p>
    CodeHighlighted uses hardcoded themes for consistent styling across all devil-ui
    applications:
  </p>
  ...
  <p class="text-sm text-devil-subtle">
...
import { highlightCode } from "@hellwrk/devil-ui/code/server";
...
import { createServerHighlighter } from "@hellwrk/devil-ui/code/server";
...
## Bundle Size
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-sm">
      <thead>
        <tr class="border-b border-devil-hairline">
      ...
      <tbody>
        <tr class="border-b border-devil-hairline/50">
  ...
  <p class="mt-4 text-sm text-devil-subtle">
    Teams that don't import from `devil-ui/code` pay 0 KB.
  </p>
</ComponentSection>
...
```tsx
// Before (deprecated)
import { Code, CodeBlock } from "@hellwrk/devil-ui";
