...
<CodeBlock code={`import { Select } from "@hellwrk/devil-ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Select } from "@hellwrk/devil-ui/components/select";`}
    lang="tsx"
  />
</ComponentSection>
...
<p>
  ...
  <ComponentExample demo="SelectLoadingDemo">
    <div class="flex flex-col gap-4">
      <p class="text-devil-default">Loading State</p>
      <SelectLoadingDemo client:load />
      <p class="text-devil-default">Loading From Server (simulated 2s delay)</p>
