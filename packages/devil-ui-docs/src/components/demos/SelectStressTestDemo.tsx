...
import { Select } from "@hellwrk/devil-ui";
...
export function SelectStrictNullChecksDemo() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded bg-devil-tint p-3 text-sm">
...
const priorities: Priority[] = [
  { level: 1, name: "Critical", color: "text-devil-danger" },
  { level: 2, name: "High", color: "text-devil-warning" },
  { level: 3, name: "Medium", color: "text-devil-default" },
  { level: 4, name: "Low", color: "text-devil-subtle" },
];
