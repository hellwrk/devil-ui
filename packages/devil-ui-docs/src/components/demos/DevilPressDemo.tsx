...
[data-theme="wordpress"] {
  ...
  --color-devil-brand: #2271b1;
  --color-devil-brand-hover: #135e96;
  --text-color-devil-brand: #2271b1;

  /* WP surfaces */
  --color-devil-base: #ffffff;
  --color-devil-elevated: #f0f0f1;
  --color-devil-recessed: #dcdcde;
  --color-devil-overlay: #ffffff;
  --color-devil-control: #ffffff;
  --color-devil-tint: #f0f0f1;
  --color-devil-fill: #dcdcde;
  --color-devil-fill-hover: #c3c4c7;
  --color-devil-contrast: #1d2327;
  --color-devil-interact: #c3c4c7;

  /* WP borders — very subtle gray */
  --color-devil-hairline: #c3c4c7;
  --color-devil-hairline: #2271b1;

  /* WP text hierarchy */
  --text-color-devil-default: #1d2327;
  --text-color-devil-strong: #50575e;
  --text-color-devil-subtle: #787c82;
  --text-color-devil-inactive: #a7aaad;
  --text-color-devil-link: #2271b1;

  /* WP semantic colors */
  --color-devil-info: #72aee6;
  --color-devil-info-tint: #e7f4fe;
  --color-devil-success: #00a32a;
  --color-devil-success-tint: #edfaef;
  --color-devil-warning: #dba617;
  --color-devil-warning-tint: #fcf9e8;
  --color-devil-danger: #d63638;
  --color-devil-danger-tint: #fcf0f1;
  --text-color-devil-success: #00a32a;
  --text-color-devil-danger: #d63638;
  --text-color-devil-warning: #dba617;
}
`;
...
const samplePosts: Post[] = [
  ...
  {
    id: "2",
    title: "Getting Started with devil-ui Press",
    author: "admin",
    categories: ["Tutorials", "Getting Started"],
    tags: ["devil-ui", "introduction"],
    comments: 12,
    date: "2026-03-09",
    status: "published",
  },
  ...
  {
    id: "4",
    title: "Draft: Upcoming Features in devil-ui Press 2.0",
    author: "admin",
    categories: ["News"],
  ...
  {
    id: "5",
    title: "Building Blocks with devil-ui Components",
    author: "contributor",
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[48px] items-center gap-2 border-b border-white/10 px-3">
        ...
        {collapsed && (
          <span className="mx-auto text-sm font-bold text-white/90">D</span>
        )}
      </div>
...
function WPTopBar({
  ...
  return (
    <div className="flex h-[48px] items-center justify-between border-b border-devil-hairline bg-devil-elevated px-4">
      <div className="flex items-center gap-4">
        <h1 className="text-lg font-semibold text-devil-default">Posts</h1>
...
// ---------------------------------------------------------------------------
export function DevilPressDemo() {
  ...
  return (
    <>
      ...
      <div
        ...
        className="flex h-[720px] overflow-hidden rounded-xl border border-devil-hairline bg-devil-elevated font-sans shadow-lg"
      >
        {/* Sidebar */}
        <div
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto bg-devil-elevated p-6">
              ...
              {[
                ...
                <span key={tab.key} className="flex items-center">
                  <button
                    ...
                    className={cn(
                      "transition-colors hover:text-devil-default",
                      statusFilter === tab.key
                        ? "font-semibold text-devil-default"
                        : "text-devil-link",
                    )}
                  >
                    {tab.label}
                    <span className="ml-1 text-devil-subtle">
                      ({statusCounts[tab.key] || 0})
                    </span>
                  </button>
                  {idx < arr.length - 1 && (
                    <span className="mx-2 text-devil-subtle">|</span>
                  )}
                </span>
              ))}
            </div>
                  ...
                  <Table.Body>
                    {filteredPosts.length === 0 ? (
                      <Table.Row>
                        <Table.Cell
                          colSpan={8}
                          className="py-12 text-center text-devil-subtle"
                        >
                          No posts found.
                        </Table.Cell>
                      </Table.Row>
                        ...
                        >
                          ...
                          <Table.Cell>
                            <div className="flex flex-col gap-0.5">
                              <span className="cursor-pointer font-medium text-devil-link hover:underline">
                                {post.title}
                              </span>
                          ...
                          <Table.Cell>
                            <span className="cursor-pointer text-devil-link hover:underline">
                              {post.author}
                            </span>
                          </Table.Cell>
                          <Table.Cell>
                            <div className="flex flex-wrap gap-1">
                              {post.categories.map((cat) => (
                                <span
                                  key={cat}
                                  className="cursor-pointer text-xs text-devil-link hover:underline"
                                >
                                  {cat}
                                </span>
                              ))}
                          ...
                          <Table.Cell>
                            <div className="flex flex-col text-xs">
                              <span className="text-devil-default">
                                {post.status === "published"
                                  ? "Published"
                                  : "Last Modified"}
                              </span>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <LayerCard>
                <LayerCard.Primary className="p-4">
                  <div className="text-xs font-medium tracking-wide text-devil-subtle uppercase">
                    Published
                  </div>
                  <div className="mt-1 text-2xl font-bold text-devil-default">
