...
export function CodeHighlightedCopyButtonDemo() {
  return (
    <DemoProvider>
      <CodeHighlighted
        code={`npm install @hellwrk/devil-ui`}
        lang="bash"
        showCopyButton
      />
    </DemoProvider>
...
export function CodeHighlightedFullFeaturedDemo() {
  return (
    <DemoProvider>
      <CodeHighlighted
        code={`import { ShikiProvider, CodeHighlighted } from "@hellwrk/devil-ui/code";
...
export function CodeHighlightedCustomHighlightDemo() {
  ...
  return (
    <DemoProvider>
      <div className="space-y-4">
        <style>{`
          #${styleId} .devil-shiki {
            --devil-code-highlight-bg: ${lightBg};
          }
          [data-mode="dark"] #${styleId} .devil-shiki {
            --devil-code-highlight-bg: ${darkBg};
          }
        `}</style>
        <div id={styleId}>
          <CodeHighlighted
  ...
  return name.toUpperCase();
        ...
        <div className="flex flex-wrap gap-6 rounded-md border border-devil-hairline bg-devil-elevated p-4">
          <label className="flex flex-col gap-2">
            <span className="text-sm text-devil-subtle">Hue: {hue}°</span>
            <input
              type="range"
              min="0"
              max="360"
          ...
          <div className="flex flex-col gap-2">
            <span className="text-sm text-devil-subtle">CSS Variable</span>
            <code className="rounded bg-devil-control px-2 py-1 font-mono text-xs">
              --devil-code-highlight-bg: {lightBg}
            </code>
          </div>
        </div>
