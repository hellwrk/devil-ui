 ...
 * It has no backgrounds or borders (transparent), uses monospace font, and text-devil-subtle color.
 *
 * ### Variant Categories
...
async function createCodeComponent(lang: string): Promise<ComponentNode> {
  ...
  const fontSize = FONT_SIZE.base; // 14px from theme-devil.css
...
export function getBaseStyles() {
  ...
  const baseStyleParts = [
    ...
    ...codeStyling.baseTokens, // ["text-devil-subtle"]
  ].filter(Boolean);
