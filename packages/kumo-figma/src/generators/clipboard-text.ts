...
async function createClipboardTextComponent(
  ...
  // Parse clipboard text base styles (bg-devil-base font-mono)
  ...
  // Apply fill - ClipboardText uses bg-devil-base (overrides input's bg-devil-control)
  ...
  // Apply border (ring-devil-line from input)
  ...
  textNode.characters = "npm install @hellwrk/devil-ui";
  textNode.fontSize = fontSize;
  textNode.fontName = { family: "Roboto Mono", style: "Regular" };
  textNode.name = "Text";

  // Apply text color (text-devil-default from input)
  ...
  // Add left border to button (border-l border-devil-fill)
  ...
  if (iconInstance) {
    ...
    // Bind icon color to text-devil-default (inherits from parent in real component)
