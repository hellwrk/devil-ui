...
describe("Switch Generator - Track Color Binding", () => {
  ...
  it("should return devil semantic color for unchecked state", () => {
    const binding = getSwitchTrackColorBinding("default", false, false);
    expect(typeof binding.bgVariableName).toBe("string");
    expect(binding.bgVariableName).toMatch(/^color-devil-/);
  });

  it("should return devil semantic color for checked default variant", () => {
    const binding = getSwitchTrackColorBinding("default", true, false);
    expect(typeof binding.bgVariableName).toBe("string");
    expect(binding.bgVariableName).toMatch(/^color-devil-/);
  });

  it("should return devil semantic color for checked error variant", () => {
