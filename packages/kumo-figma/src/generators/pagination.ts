 ...
 * Maps visual elements to Devil semantic color tokens
 */
export function getPaginationColorBindings() {
  return {
    buttonBackground: VAR_NAMES.color.control, // bg-devil-control
    buttonBorder: VAR_NAMES.color.line, // ring-devil-line
    iconEnabled: VAR_NAMES.text.default,
    iconDisabled: VAR_NAMES.text.inactive,
    inputBackground: VAR_NAMES.color.control, // bg-devil-control
    inputBorder: VAR_NAMES.color.line, // ring-devil-line
    inputText: VAR_NAMES.text.default,
    showingTextLabel: VAR_NAMES.text.strong, // From registry.colors: text-devil-subtle
  };
}
