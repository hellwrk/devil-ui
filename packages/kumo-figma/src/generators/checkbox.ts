 ...
 * - Label text: text-base font-medium text-devil-default
 *
 * Properties:
 ...
 *
 * @see packages/devil-ui/src/components/checkbox/checkbox.tsx
 */
...
export function getCheckboxBoxConfig(
  ...
  return {
    ...
    // Icon uses text-devil-inverse from checkbox.tsx
    iconColor: iconName ? "text-devil-inverse" : null,
...
function createCheckboxBox(
  ...
  if (boxConfig.icon && boxConfig.iconSize) {
    ...
    if (iconInstance) {
      bindIconColor(iconInstance, boxConfig.iconColor || "text-devil-inverse");
