 ...
 *
 * @see packages/devil-ui/src/components/combobox/combobox.tsx
 */
 ...
 * "bg-devil-control ring ring-devil-line rounded-lg"
 */
const TRIGGER_BASE_STYLES = "bg-devil-control ring ring-devil-line rounded-lg";

/**
 * Dropdown panel styles
 * "bg-devil-base border border-devil-line"
 */
const DROPDOWN_PANEL_STYLES = "bg-devil-base border border-devil-line";
...
const FALLBACK_COMBOBOX_CONFIG = {
  ...
  label: {
    fontSize: FONT_SIZE.base, // text-base = 14px from theme-devil.css
    fontWeight: FALLBACK_VALUES.fontWeight.medium, // font-medium = 500
  },
  placeholder: {
    fontSize: FONT_SIZE.lg, // text-lg = 16px from theme-devil.css
    fontWeight: FALLBACK_VALUES.fontWeight.normal, // font-normal = 400
  },
  description: {
    fontSize: FONT_SIZE.xs, // text-xs = 12px from theme-devil.css
    fontWeight: FALLBACK_VALUES.fontWeight.normal, // font-normal = 400
  },
  item: {
    fontSize: FONT_SIZE.base, // text-base = 14px from theme-devil.css
...
async function createComboboxComponent(
  ...
  if (variantConfig.label) {
    ...
    // Apply label text color (text-devil-strong)
  ...
  // Apply background fill (bg-devil-control)
  ...
  // Apply text color (text-devil-subtle for placeholder)
  ...
  const iconColorToken =
    state === "disabled" ? "text-devil-inactive" : "text-devil-default";
  ...
  if (variantConfig.description) {
    ...
    // Apply description text color (text-devil-subtle)
  ...
  if (variantConfig.errorMessage) {
    ...
    // Apply error text color (text-devil-danger)
  ...
  if (open) {
    ...
    // Apply background fill (bg-devil-control) - matches Content/Popup in combobox.tsx
    ...
    for (let i = 0; i < itemLabels.length; i++) {
      ...
      // Highlight second item (selected/hover state) - matches data-highlighted:bg-devil-overlay
      if (i === 1) {
