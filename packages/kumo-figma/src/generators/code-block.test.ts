...
const CODE_BLOCK_WRAPPER_STYLES =
  "min-w-0 rounded-md border border-devil-fill bg-devil-base";
...
describe("CodeBlock Generator - Color Token Parsing", () => {
  ...
  it("should parse fill variable from bg-devil-base", () => {
    const parsed = parseTailwindClasses("bg-devil-base");
    expect(parsed.fillVariable).toBeDefined();
    expect(typeof parsed.fillVariable).toBe("string");
  });

  it("should parse stroke variable from border-devil-fill", () => {
