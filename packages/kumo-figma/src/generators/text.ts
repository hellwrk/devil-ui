 ...
 *
 * ### Base Styling
 * All text variants get `text-devil-default` as the base color, then variant classes override.
 */
...
async function createTextComponent(
  ...
  // Apply text color
  // Priority: variant-specific color > base text-devil-default color
  if (styles.textVariable) {
    ...
    // Fallback to base text-devil-default color
