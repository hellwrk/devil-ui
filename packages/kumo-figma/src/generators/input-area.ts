 ...
 *
 * @see packages/devil-ui/src/components/input/input-area.tsx
 */
...
async function createInputAreaComponent(
  ...
  // Apply text color (text-devil-subtle for placeholder, text-devil-default for value in error)
  const textColorVar =
    variant === "error"
