 ...
 *
 * @see packages/devil-ui/src/components/surface/surface.tsx
 */
 ...
 */
const BASE_STYLES = "shadow-xs ring ring-devil-line";
...
async function createSurfaceComponent(): Promise<ComponentNode> {
  ...
  const contentText = await createTextNode(
    "Surface content",
    FONT_SIZE.base, // 14px from theme-devil.css
...
export function getAllSurfaceData() {
  ...
  return {
    ...
    contentText: {
      ...
      fontSize: FONT_SIZE.base, // 14px from theme-devil.css
