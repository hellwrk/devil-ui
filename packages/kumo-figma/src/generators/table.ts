 ...
 *
 * @see packages/devil-ui/src/components/table/table.tsx
 */
...
export function getTableSelectedRowConfig() {
  return {
    bgVariable: VAR_NAMES.color.tint, // bg-devil-tint
  };
}
...
export function getTableCheckboxCellConfig() {
  return {
    ...
    checkedBgVariable: VAR_NAMES.color.contrast, // color-devil-contrast (inverse of base)
    borderVariable: VAR_NAMES.color.line,
    iconName: "ph-check" as const,
    iconSize: 12, // Small icon inside 16px box
    iconColor: "text-devil-inverse",
  };
}
...
async function createTableComponent(
  ...
  // Add outer border (matches LayerCard.Primary: ring ring-devil-fill rounded-lg)
