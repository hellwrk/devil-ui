 ...
 * Extracts patterns like `bg-devil-brand/70`, `text-devil-danger/50` and generates
 * Figma variable definitions for `opacity-primary-70`, `opacity-error-50`, etc.
 *
 * @example
 * // Input from button.tsx:
 * // "bg-devil-brand/70 hover:bg-devil-brand/50"
 *
 * // Output:
 * // [
 ...
 *
 * Examples:
 * - bg-devil-brand/70 → token: "primary", opacity: 70
 * - text-devil-danger/50 → token: "error", opacity: 50
 * - border-devil-control/30 → token: "secondary", opacity: 30
 */
 ...
 * @example
 * const code = `
 *   primary: "bg-devil-brand hover:bg-devil-brand/70 disabled:bg-devil-brand/50",
 *   error: "bg-devil-danger text-white hover:bg-devil-danger/70"
 * `;
...
/**
 * Pre-extracted opacity modifiers from Devil component source files.
 ...
 * - packages/devil-ui/src/components/badge/badge.tsx
 */
export const BUNDLED_OPACITY_MODIFIERS: OpacityModifier[] = [
  // From button.tsx primary variant: hover:bg-primary/70, disabled:bg-devil-brand/50
  { token: "primary", opacity: 70, variableName: "opacity-primary-70" },
  { token: "primary", opacity: 50, variableName: "opacity-primary-50" },
  // From button.tsx secondary variant: disabled:bg-secondary/50, disabled:!text-devil-default/70
  { token: "secondary", opacity: 50, variableName: "opacity-secondary-50" },
  { token: "surface", opacity: 70, variableName: "opacity-surface-70" },
  // From button.tsx destructive variant: hover:bg-devil-danger/70
  { token: "error", opacity: 70, variableName: "opacity-error-70" },
  // From button.tsx secondary-destructive variant: disabled:!text-devil-danger/70
