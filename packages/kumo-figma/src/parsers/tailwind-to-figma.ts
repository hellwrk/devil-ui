 ...
 * source of truth (the DEVIL_*_VARIANTS objects).
 *
...
/**
 * Devil font size scale (in pixels)
 * Generated from: theme-devil.css @theme definitions (Devil overrides Tailwind defaults)
 */
const FONT_SIZE_SCALE: Record<string, number> = {
  ...themeData.devil.fontSize,
...
/**
 * Map Devil semantic color classes to Figma variable names
 * These must match the kumo-colors collection in Figma (generated from theme-devil.css)
 *
 * Variable names follow the pattern from theme-devil.css:
 * - Background/fill colors: "color-devil-{name}" (e.g., "color-devil-brand", "color-devil-base")
 * - Text colors: "text-color-devil-{name}" (e.g., "text-color-devil-default", "text-color-devil-subtle")
 */
const COLOR_TO_VARIABLE: Record<string, string> = {
  // Background colors (--color-devil-* tokens from theme-devil.css)
  "bg-devil-base": "color-devil-base",
  "bg-devil-elevated": "color-devil-elevated",
  "bg-devil-recessed": "color-devil-recessed",
  "bg-devil-overlay": "color-devil-overlay",
  "bg-devil-contrast": "color-devil-contrast",
  "bg-devil-control": "color-devil-control",
  "bg-devil-tint": "color-devil-tint",
  "bg-devil-interact": "color-devil-interact",
  "bg-devil-fill": "color-devil-fill",
  "bg-devil-brand": "color-devil-brand",
  "bg-devil-brand-hover": "color-devil-brand-hover",
  "bg-devil-line": "color-devil-line",
  "bg-devil-hairline": "color-devil-hairline",
  "bg-devil-info": "color-devil-info",
  "bg-devil-info-tint": "color-devil-info-tint",
  "bg-devil-warning": "color-devil-warning",
  "bg-devil-warning-tint": "color-devil-warning-tint",
  "bg-devil-danger": "color-devil-danger",
  "bg-devil-danger-tint": "color-devil-danger-tint",
  "bg-devil-success": "color-devil-success",
  "bg-devil-success-tint": "color-devil-success-tint",
  "bg-transparent": null!, // No fill
  "bg-inherit": null!, // No fill

  // Text colors (--text-color-devil-* tokens from theme-devil.css)
  "text-white": null!, // Hardcoded white
  "text-devil-default": "text-color-devil-default",
  "text-devil-inverse": "text-color-devil-inverse",
  "text-devil-strong": "text-color-devil-strong",
  "text-devil-subtle": "text-color-devil-subtle",
  "text-devil-inactive": "text-color-devil-inactive",
  "text-devil-brand": "text-color-devil-brand",
  "text-devil-link": "text-color-devil-link",
  "text-devil-success": "text-color-devil-success",
  "text-devil-danger": "text-color-devil-danger",
  "text-devil-warning": "text-color-devil-warning",
  "!text-white": null!, // Hardcoded white (important)
  "!text-devil-default": "text-color-devil-default",
  "!text-devil-danger": "text-color-devil-danger",

  // Border colors (use --color-devil-* tokens)
  "border-devil-line": "color-devil-line",
  "border-devil-hairline": "color-devil-hairline",
  "border-devil-brand": "color-devil-brand",
  "border-devil-fill": "color-devil-fill",
  "border-devil-info": "color-devil-info",
  "border-devil-warning": "color-devil-warning",
  "border-devil-danger": "color-devil-danger",
  "border-devil-success": "color-devil-success",
  "ring-devil-line": "color-devil-line",
  "ring-devil-hairline": "color-devil-hairline",
  "ring-devil-danger": "color-devil-danger",
};
...
export function parseTailwindClasses(classes: string): ParsedStyles {
  ...
  for (const cls of classList) {
    ...
    // Background colors (with optional opacity: bg-devil-info/20)
    if (cls.startsWith("bg-")) {
      // Check for opacity modifier (e.g., bg-devil-info/20)
    ...
    if (cls === "border" || cls.startsWith("border-")) {
      ...
      if (cls === "border-dashed") {
        ...
        // Check for opacity modifier (e.g., border-devil-danger/50)
    ...
    if (cls === "ring" || cls.startsWith("ring-")) {
      result.hasBorder = true;
      // Check for opacity modifier (e.g., ring-devil-hairline/50)
