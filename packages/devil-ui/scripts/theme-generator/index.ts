...
function printHelp() {
  console.log(`
Devil Theme Generator

Usage:
  tsx scripts/devil-theme-generator/index.ts [options]
...
Output:
  ...
  - theme-devil.css     Base theme with all tokens
...
async function main() {
  ...
  console.log("Devil Theme Generator\n");
