...
export const COMPONENT_STYLING_METADATA: Record<string, ComponentStyling> = {
  Checkbox: {
    ...
    baseTokens: ["bg-devil-base", "ring-devil-line"],
    states: {
  ...
  Input: {
    ...
    states: {
      base: ["bg-devil-control", "text-devil-default", "ring-devil-line"],
      focus: ["ring-devil-hairline"],
      error: ["ring-devil-danger"],
      disabled: ["opacity-50", "text-devil-subtle"],
    },
  },
  Tabs: {
    container: {
  ...
  Dialog: {
    ...
    states: {
      base: ["bg-devil-base", "text-devil-default", "shadow-m"],
      backdrop: ["bg-devil-overlay", "opacity-80"],
    },
  },
  // Note: Toasty styling is now extracted from DEVIL_TOAST_STYLING in toast.tsx
  DateRangePicker: {
    sizeVariants: {
      sm: {
        height: 0,
