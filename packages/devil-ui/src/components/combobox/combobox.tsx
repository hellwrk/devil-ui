...
export const DEVIL_COMBOBOX_VARIANTS = {
...
export const DEVIL_COMBOBOX_DEFAULT_VARIANTS = {
  size: "base",
  inputSide: "right",
} as const;
...
// Derived types from DEVIL_COMBOBOX_VARIANTS
export type DevilComboboxSize = keyof typeof DEVIL_COMBOBOX_VARIANTS.size;
export type DevilComboboxInputSide =
  keyof typeof DEVIL_COMBOBOX_VARIANTS.inputSide;

export interface DevilComboboxVariantsProps {
  /**
   ...
   * @default "right"
   */
  inputSide?: DevilComboboxInputSide;
}

export function comboboxVariants({
  inputSide = DEVIL_COMBOBOX_DEFAULT_VARIANTS.inputSide,
}: DevilComboboxVariantsProps = {}) {
  return cn(
    resolveVariant(
      DEVIL_COMBOBOX_VARIANTS.inputSide,
      inputSide,
      DEVIL_COMBOBOX_DEFAULT_VARIANTS.inputSide,
    ).classes,
  );
}

// Legacy type alias for backwards compatibility
export type ComboboxInputSide = DevilComboboxInputSide;
export type ComboboxSize = DevilComboboxSize;
 ...
 * ```
 */
export interface ComboboxProps extends DevilComboboxVariantsProps {
      ...
      >
        <ComboboxBase.Popup
          className={cn(
            ...
            "bg-devil-base text-devil-default", // background
  ...
  return (
    <ComboboxBase.Trigger
      ...
      className={cn(
        ...
        "data-[placeholder]:text-devil-placeholder",
        iconStyles.padding,
        className,
      )}
    >
      ...
      <ComboboxBase.Icon
        className={cn(
          "absolute top-1/2 flex -translate-y-1/2 items-center text-devil-subtle",
  ...
  return (
    ...
    >
      ...
      <ComboboxBase.Trigger
        ...
        className={cn(
          "absolute top-1/2 flex -translate-y-1/2 cursor-pointer items-center justify-center text-devil-subtle",
  ...
  return (
    <ComboboxBase.Item
      ...
      className={cn(
        ...
        "cursor-pointer data-highlighted:bg-devil-tint",
        ...
        "data-[disabled]:cursor-not-allowed data-[disabled]:text-devil-subtle data-[disabled]:opacity-60 data-[disabled]:data-highlighted:bg-transparent",
        className,
      )}
    >
...
function Empty(props: ComboboxBase.Empty.Props) {
  return (
    <ComboboxBase.Empty
      {...props}
      className={cn(
        "mx-1.5 shrink-0 px-4 py-2 text-[0.925rem] leading-4 text-devil-subtle empty:m-0 empty:p-0",
      )}
...
function GroupLabel(props: ComboboxBase.GroupLabel.Props) {
  return (
    <ComboboxBase.GroupLabel
      {...props}
      className={cn(
        "mx-1.5 px-2 py-1.5 text-sm text-devil-subtle",
        props.className,
      )}
    />
  );
...
function Group(props: ComboboxBase.Group.Props) {
  return (
    <ComboboxBase.Group
      {...props}
      className="mt-2 border-t border-devil-hairline pt-2 first:mt-0 first:border-t-0 first:pt-0"
    />
  );
}
  ...
  return (
    <ComboboxBase.Chip
      ...
      className={cn(
        ...
        "rounded-sm ring-1 ring-devil-hairline", // Border
        "bg-devil-overlay", // Background
        "text-sm", // Typography
      )}
    >
      {props.children}
      <ComboboxBase.ChipRemove
        data-devil-component="Combobox"
        data-devil-part="chip-remove"
        aria-label={removeLabel}
        className={cn(
          "cursor-pointer rounded-md p-1 hover:bg-devil-fill-hover",
          "flex bg-transparent",
        )}
      >
        <XIcon size={10} />
...
const sizeToMinHeight: Record<DevilComboboxSize, string> = {
  xs: "min-h-5",
  sm: "min-h-6.5",
  base: "min-h-9",
  lg: "min-h-10",
