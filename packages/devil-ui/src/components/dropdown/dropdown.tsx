...
export const DEVIL_DROPDOWN_VARIANTS = {
  variant: {
    default: {
      classes: "",
    ...
    danger: {
      classes:
        "text-devil-danger data-highlighted:bg-devil-danger/5 data-highlighted:text-devil-danger",
      description: "Destructive action item",
    },
  },
} as const;

export const DEVIL_DROPDOWN_DEFAULT_VARIANTS = {
  variant: "default",
} as const;

// Derived types from DEVIL_DROPDOWN_VARIANTS
export type DevilDropdownVariant = keyof typeof DEVIL_DROPDOWN_VARIANTS.variant;

export interface DevilDropdownVariantsProps {
  /**
   ...
   * @default "default"
   */
  variant?: DevilDropdownVariant;
}

export function dropdownVariants({
  variant = DEVIL_DROPDOWN_DEFAULT_VARIANTS.variant,
}: DevilDropdownVariantsProps = {}) {
  return cn(
    resolveVariant(
      DEVIL_DROPDOWN_VARIANTS.variant,
      variant,
      DEVIL_DROPDOWN_DEFAULT_VARIANTS.variant,
    ).classes,
  );
}
...
>(({ className, inset, children, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.SubmenuTrigger
    ref={ref}
    data-devil-component="DropdownMenu"
    data-devil-part="submenu-trigger"
    className={cn(
      "flex cursor-default items-center rounded-sm text-base outline-hidden select-none", // base styles
      "px-2 py-1.5", // spacing
      "focus:bg-devil-tint focus:ring-devil-focus/50 focus-visible:ring-2 focus-visible:ring-devil-brand", // focus state
      "data-[state=open]:bg-devil-tint", // open state
      ...
      <DropdownMenuPrimitive.Portal container={container}>
        ...
        >
          <DropdownMenuPrimitive.Popup
            className={cn(
              "overflow-hidden bg-devil-control text-devil-default", // background
              "max-h-[var(--available-height)] overflow-y-auto", // limit height when list is too long and might go off screen
              "rounded-lg shadow-lg ring ring-devil-line", // border part
  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.Item
        ...
        className={cn(
          "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none focus:text-devil-default focus:ring-devil-focus/50 focus-visible:ring-2 focus-visible:ring-devil-brand data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-devil-overlay",
          inset && "pl-8",
  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.LinkItem
        ref={ref}
        data-devil-component="DropdownMenu"
        data-devil-part="link-item"
        className={cn(
          "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none",
          "focus:text-devil-default focus:ring-devil-focus/50 focus-visible:ring-2 focus-visible:ring-devil-brand data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-devil-overlay",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    data-devil-component="DropdownMenu"
    data-devil-part="checkbox-item"
    className={cn(
      "relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-base outline-hidden transition-colors select-none focus:bg-devil-tint focus:text-devil-default focus:ring-devil-focus/50 focus-visible:ring-2 focus-visible:ring-devil-brand data-disabled:pointer-events-none data-disabled:opacity-50",
      className,
    )}
    checked={checked}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-devil-hairline", className)}
    {...props}
  />
));
...
>(({ className, children, inset, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    data-devil-component="DropdownMenu"
    data-devil-part="radio-item"
    className={cn(
      "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none",
      "data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-devil-tint",
      inset && "pl-8",
      className,
    )}
    {...props}
