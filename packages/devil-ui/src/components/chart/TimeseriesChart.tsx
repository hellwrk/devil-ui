...
import { Chart, ChartEvents, DevilChartOption } from "./EChart";
        ...
        <TooltipPrimitive.Portal>
          ...
          >
            <TooltipPrimitive.Popup
              ...
              className="max-w-xs min-w-[150px] rounded-lg bg-devil-base p-2 shadow-md outline-1 outline-devil-line"
            >
              <TooltipContent
                state={tooltipState}
...
function ChartSkeletonLoader({
  ...
  const id = `devil-chart-loader-${useId().replace(/[^a-zA-Z0-9_-]/g, "")}`;
