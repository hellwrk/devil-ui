 ...
 * Uses `onChange` instead of `onSelect` for Devil consistency.
 ...
 *
 * Built on [react-day-picker](https://daypicker.dev) with Devil styling.
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...classNames,
        root: cn(
          "rdp-root rounded-xl bg-devil-base select-none",
          classNames?.root,
          className,
        ),
      }}
