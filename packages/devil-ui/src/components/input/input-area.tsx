...
export const InputArea = React.forwardRef<HTMLTextAreaElement, InputAreaProps>(
  (props, ref) => {
    ...
    if (process.env.NODE_ENV !== "production" && variantProp === "error") {
      console.warn(
        '[Devil InputArea]: variant="error" is deprecated. ' +
    ...
    const textareaClassName = cn(
      ...
      autoResize &&
        "field-sizing-content w-full resize-none scroll-pb-2 [scrollbar-width:thin] [scrollbar-color:var(--color-devil-line)_transparent] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar]:bg-transparent [&::-webkit-scrollbar-corner]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-devil-line [&::-webkit-scrollbar-track]:my-2",
      className,
    );
