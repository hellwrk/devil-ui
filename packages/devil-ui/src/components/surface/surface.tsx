...
export const DEVIL_SURFACE_VARIANTS = {
  color: {
    primary: {
      classes: "",
...
export const DEVIL_SURFACE_DEFAULT_VARIANTS = {
  color: "primary",
} as const;

// Derived types from DEVIL_SURFACE_VARIANTS
export type DevilSurfaceColor = keyof typeof DEVIL_SURFACE_VARIANTS.color;

export interface DevilSurfaceVariantsProps {
  /**
   ...
   * @default "primary"
   */
  color?: DevilSurfaceColor;
}

export function surfaceVariants({
  color = DEVIL_SURFACE_DEFAULT_VARIANTS.color,
}: DevilSurfaceVariantsProps = {}) {
  return resolveVariant(
    DEVIL_SURFACE_VARIANTS.color,
    color,
    DEVIL_SURFACE_DEFAULT_VARIANTS.color,
  ).classes;
}
