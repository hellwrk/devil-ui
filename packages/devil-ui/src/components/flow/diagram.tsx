  ...
  return (
    <FlowStateContext.Provider value={flowStateContextValue}>
      ...
      >
        ...
        {/* Vertical scrollbar */}
        {canScrollY && (
          <div className="absolute top-1 right-1 bottom-1 w-1.5 rounded-full bg-devil-hairline/50 opacity-0 group-hover:opacity-100">
            <motion.div
              className="absolute w-full rounded-full bg-devil-fill"
              style={{
        ...
        {canScrollX && (
          <div className="absolute right-1 bottom-1 left-1 h-1.5 rounded-full bg-devil-hairline/50 opacity-0 group-hover:opacity-100">
            <motion.div
              className="absolute h-full rounded-full bg-devil-fill"
              style={{
