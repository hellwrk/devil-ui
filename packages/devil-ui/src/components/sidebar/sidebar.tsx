...
// ============================================================================
// Variants (required by Devil convention)
// ============================================================================

/** Sidebar variant definitions mapping layout, collapse, and side options. */
export const DEVIL_SIDEBAR_VARIANTS = {
  variant: {
    sidebar: {
      classes: "",
...
export const DEVIL_SIDEBAR_DEFAULT_VARIANTS = {
  variant: "sidebar",
  collapsible: "icon",
  side: "left",
} as const;

export const DEVIL_SIDEBAR_STYLING = {
  width: {
    expanded: "16.25rem",
    icon: "57px",
  },
...
function SidebarProvider({
  ...
  variant = DEVIL_SIDEBAR_DEFAULT_VARIANTS.variant,
  side = DEVIL_SIDEBAR_DEFAULT_VARIANTS.side,
  collapsible = DEVIL_SIDEBAR_DEFAULT_VARIANTS.collapsible,
  resizable = false,
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper relative isolate flex w-full [--sidebar-active-bg:var(--color-devil-tint)] [--sidebar-bg:var(--color-devil-base)]",
          !contained && !isMobile && "min-h-svh",
          "has-data-[variant=inset]:bg-devil-recessed",
    ...
    if (collapsible === "none") {
      return (
        <aside
          ...
          className={cn(
            "relative flex h-full shrink-0 grow-0 flex-col overflow-hidden bg-(--sidebar-bg) text-devil-default",
            variant === "sidebar" &&
              (side === "left"
                ? "border-r border-devil-line"
                : "border-l border-devil-line"),
            variant === "floating" &&
              "m-2 rounded-lg border border-devil-line shadow-lg",
            className,
          )}
          {...props}
        >
      ...
      return (
        <>
          ...
          <div
            ...
            className={cn(
              contained
                ? "absolute inset-0 z-40 bg-devil-recessed"
                : "fixed inset-0 z-40 bg-devil-recessed",
          ...
          <nav
            ...
            className={cn(
              ...
              "bg-(--sidebar-bg) text-devil-default",
              // No border when full-screen — there is no adjacent content to divide.
              !fullScreenOnMobile && "border-r border-devil-line",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="header"
    className={cn(
      "flex h-[58px] shrink-0 items-center gap-1 border-b border-devil-line",
...
>(({ className, children, ...props }, ref) => {
  return (
    ...
    >
      ...
      >
        <ScrollAreaBase.Thumb className="flex-1 rounded-full bg-devil-line" />
      </ScrollAreaBase.Scrollbar>
    </ScrollAreaBase.Root>
  );
});
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="footer"
    className={cn(
      "flex h-12 shrink-0 items-center gap-4 overflow-hidden border-t border-devil-line whitespace-nowrap",
      ...
      "group-data-[state=collapsed]/sidebar:border-r group-data-[state=collapsed]/sidebar:border-devil-line",
      className,
    )}
    {...props}
  />
 ...
 * shares Devil's skeleton shimmer. Drop it in place of the nav content while
...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "my-3 grid-rows-[0fr] border-b border-devil-line",
  ...
  >
    <div className="min-h-0 min-w-0">
      <div
        className={cn(
          "mt-4 mb-2 truncate px-3 text-sm font-medium text-devil-subtle",
...
const SidebarMenuButton = forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(
  (
    ...
    const buttonClasses = cn(
      ...
      // Focus
      "focus:outline-none focus-visible:bg-(--sidebar-active-bg) focus-visible:text-devil-strong",
      className,
    );
    ...
    if (href) {
      button = (
        <LinkComponent
          ...
          data-devil-component="Sidebar"
          data-devil-part="menu-button-link"
          data-size={size}
        >
          {content}
        </LinkComponent>
...
>(({ className, ...props }, ref) => (
  <span
    ...
    className={cn(
      "inline-flex shrink-0 items-center rounded-full border border-dashed border-devil-line",
      "px-1.5 py-0.5 text-[11px]/none font-medium text-devil-strong select-none",
...
>(({ className, children, ...props }, ref) => (
  <ul
    ...
    {...props}
  >
    <div className="absolute inset-y-px left-[19px] z-10 w-px bg-devil-line" />
    {children}
  </ul>
));
...
>(({ className, active = false, href, target, children, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    ...
    "before:absolute before:inset-x-0 before:-inset-y-px",
    "text-devil-default transition-[color] duration-150",
    !active && "hover:bg-(--sidebar-active-bg)",
    active && "bg-(--sidebar-active-bg)",
    "focus:outline-none focus-visible:bg-(--sidebar-active-bg) focus-visible:text-devil-strong",
    className,
  ...
  if (href) {
    button = (
      <LinkComponent
        ...
        data-devil-component="Sidebar"
        data-devil-part="menu-sub-button-link"
      >
        {content}
      </LinkComponent>
    );
    ...
    button = (
      <button
        ...
        data-sidebar="menu-sub-button"
        data-devil-component="Sidebar"
        data-devil-part="menu-sub-button"
        {...props}
      >
        {content}
      </button>
...
>(({ className, ...props }, ref) => (
  <div
    ...
    {...props}
  >
    <div className="border-b border-devil-line" />
  </div>
));
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-devil-subtle hover:bg-(--sidebar-active-bg) hover:text-devil-default",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-devil-brand focus-visible:ring-inset",
        className,
      )}
      onClick={(e) => {
        onClick?.(e);
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:after:bg-devil-hairline focus-visible:after:bg-devil-hairline active:after:bg-devil-hairline",
        "focus:outline-none",
