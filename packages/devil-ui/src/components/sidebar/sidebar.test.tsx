...
describe("Sidebar exports", () => {
  ...
  it("should export variant definitions", () => {
    expect(DEVIL_SIDEBAR_VARIANTS.variant).toHaveProperty("sidebar");
    expect(DEVIL_SIDEBAR_VARIANTS.variant).toHaveProperty("floating");
    expect(DEVIL_SIDEBAR_VARIANTS.variant).toHaveProperty("inset");
    expect(DEVIL_SIDEBAR_VARIANTS.collapsible).toHaveProperty("icon");
    expect(DEVIL_SIDEBAR_VARIANTS.collapsible).toHaveProperty("offcanvas");
    expect(DEVIL_SIDEBAR_VARIANTS.collapsible).toHaveProperty("none");
    expect(DEVIL_SIDEBAR_VARIANTS.side).toHaveProperty("left");
    expect(DEVIL_SIDEBAR_VARIANTS.side).toHaveProperty("right");
  });

  it("should export default variants", () => {
    expect(DEVIL_SIDEBAR_DEFAULT_VARIANTS.variant).toBe("sidebar");
    expect(DEVIL_SIDEBAR_DEFAULT_VARIANTS.side).toBe("left");
    expect(DEVIL_SIDEBAR_DEFAULT_VARIANTS.collapsible).toBe("icon");
  });

  it("should export updated styling metadata", () => {
    expect(DEVIL_SIDEBAR_STYLING.width.expanded).toBe("16.25rem");
    expect(DEVIL_SIDEBAR_STYLING.width.icon).toBe("57px");
  });
...
describe("Sidebar.MenuButton", () => {
  ...
  it("should preserve extra link attributes when href provided", () => {
    ...
    expect(link!.getAttribute("data-devil-part")).toBe("menu-button-link");
  });
});
...
describe("Sidebar.MenuSubButton", () => {
  ...
  it("should preserve extra link attributes when href provided", () => {
    ...
    expect(link!.getAttribute("data-active")).toBe("true");
    expect(link!.getAttribute("data-devil-part")).toBe("menu-sub-button-link");
  });
});
