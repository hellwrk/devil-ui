...
describe("Radio", () => {
  ...
  it("exports DEVIL_RADIO_VARIANTS with appearance axis", () => {
    expect(DEVIL_RADIO_VARIANTS.appearance.default).toBeDefined();
    expect(DEVIL_RADIO_VARIANTS.appearance.card).toBeDefined();
    expect(DEVIL_RADIO_DEFAULT_VARIANTS.appearance).toBe("default");
  });
});
