...
export const DEVIL_CLOUDFLARE_LOGO_VARIANTS = {
  variant: {
    glyph: {
...
export const DEVIL_CLOUDFLARE_LOGO_DEFAULT_VARIANTS = {
  variant: "full",
  color: "color",
} as const;

export type CloudflareLogoVariant =
  keyof typeof DEVIL_CLOUDFLARE_LOGO_VARIANTS.variant;
export type CloudflareLogoColor =
  keyof typeof DEVIL_CLOUDFLARE_LOGO_VARIANTS.color;
...
export const CloudflareLogo = forwardRef<SVGSVGElement, CloudflareLogoProps>(
  (
    {
      variant = DEVIL_CLOUDFLARE_LOGO_DEFAULT_VARIANTS.variant,
      color = DEVIL_CLOUDFLARE_LOGO_DEFAULT_VARIANTS.color,
      className,
      ...props
    },
    ref,
    ...
    // Wordmark uses currentColor to respect dark mode (via text-devil-default class)
    ...
    return (
      <svg
        ...
        className={cn(
          ...
          color === "color" && "text-devil-default",
          color === "white" && "text-white",
          color === "black" && "text-black",
          className,
        )}
    ...
    return (
      <a
        ...
        className={cn(
          ...
          color === "color" &&
            "bg-devil-base text-devil-default ring-devil-hairline",
