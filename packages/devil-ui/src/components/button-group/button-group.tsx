 ...
 * required exports are kept for the Devil variant standard.
 */
export const DEVIL_BUTTON_GROUP_VARIANTS = {} as const;

export const DEVIL_BUTTON_GROUP_DEFAULT_VARIANTS = {} as const;

/** Base classes shared by every ButtonGroup. */
export const DEVIL_BUTTON_GROUP_STYLING = {
  baseClasses: cn(
    ...
    // Each devil Button carries its own `shadow-xs`. Inside a group those
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ...
        ref={ref}
        role="group"
        data-devil-component="ButtonGroup"
        className={cn(DEVIL_BUTTON_GROUP_STYLING.baseClasses, className)}
      >
        {children}
      </div>
    );
