...
import { Tooltip, type DevilTooltipSide } from "../tooltip/tooltip";
import type { DevilInputSize } from "../input/input";
import {
  INPUT_GROUP_SIZE,
 ...
 */
const COMPACT_BUTTON_SIZE: Record<DevilInputSize, DevilInputSize> = {
  xs: "xs",
  sm: "xs",
  base: "sm",
  lg: "base",
    ...
    const btn = (
      <ButtonExternal
        ...
        className={cn(
          ...
          !isIndividual &&
            "focus-visible:ring-[1.5px] focus-visible:ring-devil-focus/50",
          ...
          isIndividual && [
            ...
            "relative h-full! rounded-none border border-devil-line ring-0 focus-visible:ring-0",
            ...
            "focus:z-2",
            "focus-visible:border-devil-focus/50",
            "disabled:bg-devil-overlay disabled:text-devil-inactive!",
          ],
          className,
        )}
      >
