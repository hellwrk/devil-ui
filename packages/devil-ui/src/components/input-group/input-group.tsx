...
export const DEVIL_INPUT_GROUP_VARIANTS = {
  size: {
    xs: {
      classes: "h-6 text-xs",
...
export const DEVIL_INPUT_GROUP_DEFAULT_VARIANTS = {
  size: "base",
} as const;
...
>(
  (
    ...
    const containerClassName = cn(
      ...
      // inputVariants provides base ring-devil-line; must come before state overrides
      inputVariants({ size }),
      ...
      focusMode === "container"
        ? [
            "overflow-hidden",
            // Focus state must come AFTER inputVariants to override ring-devil-line
      ...
      "has-[input[aria-invalid=true]]:ring-devil-danger",
    ...
    // Data attributes drive CSS selectors in devil-binding.css (focus outline)
          ...
          <InputGroupContext.Provider value={containerZoneContext}>
            <div
              ...
              className={cn(
                ...
                "focus-within:border-devil-focus/50",
