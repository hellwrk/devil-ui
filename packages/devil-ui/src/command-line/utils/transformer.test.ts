...
describe("transformImports", () => {
  it("transforms component imports from relative to package", () => {
    ...
    const expected = `import { Tabs } from "@hellwrk/devil-ui";`;
  ...
  it("consolidates mixed value and type imports using inline type syntax", () => {
    ...
    const expected = `import { Tabs, type TabsItem } from "@hellwrk/devil-ui";`;
    expect(transformImports(input)).toBe(expected);
  });

  it("handles inline type imports for multiple types", () => {
    const input = `import { type TabsItem, type TabsProps } from "../../components/tabs";`;
    const expected = `import { type TabsItem, type TabsProps } from "@hellwrk/devil-ui";`;
    expect(transformImports(input)).toBe(expected);
  });
  ...
  it("consolidates multiple import statements from devil into a single import", () => {
    const input = `import { ReactNode } from "react";
import { Tabs, type TabsItem } from "../../components/tabs";
import { cn } from "../../utils/cn";`;

    const expected = `import { ReactNode } from "react";
import { Tabs, cn, type TabsItem } from "@hellwrk/devil-ui";`;
  ...
  it("handles complex mixed imports with multiple values and types", () => {
    ...
    const expected = `import { Button, Input, Select, type ButtonProps, type InputProps } from "@hellwrk/devil-ui";`;
    expect(transformImports(input)).toBe(expected);
  });
...
import { Dialog, DialogRoot, DialogTitle, DialogClose, Input, Button, cn, Banner } from "@hellwrk/devil-ui";
import {
  CheckIcon,
  CopyIcon,
  WarningCircleIcon,
...
import { Input, type InputProps } from "../../components/input";`;
    ...
    const expected = `import { Dialog, Button, Input, type DialogProps, type ButtonProps, type InputProps } from "@hellwrk/devil-ui";`;
...
import type { ButtonProps } from "../../components/button";`;
    ...
    const expected = `import { type DialogProps, type ButtonProps } from "@hellwrk/devil-ui";`;
