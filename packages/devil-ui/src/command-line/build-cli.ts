#!/usr/bin/env node
/**
 * Build script for the Devil CLI
...
const packageRoot = join(__dirname, "../.."); // src/command-line -> packages/devil-ui
...
console.log("Building Devil CLI...");
...
console.log("Devil CLI built successfully!");
