 ...
 * ```tsx
 * // Next.js RSC
 * import { highlightCode, CodeBlock } from "@hellwrk/devil-ui/code/server";
 *
 ...
 * to render syntax-highlighted code blocks with consistent Devil styling.
 *
 * @example
 * ```tsx
 * import { highlightCode, CodeBlock } from "@hellwrk/devil-ui/code/server";
...
export function CodeBlock({ html, className }: CodeBlockProps): ReactNode {
  const containerClass = className
    ? `group relative w-full min-w-0 rounded-md border border-devil-fill bg-devil-base ${className}`
    : "group relative w-full min-w-0 rounded-md border border-devil-fill bg-devil-base";

  return (
    <div className={containerClass}>
      <div className="overflow-x-auto">
        <div
          className="devil-shiki [&>pre]:p-4 [&>pre]:font-mono [&>pre]:text-sm [&>pre]:leading-relaxed"
