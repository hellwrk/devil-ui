...
export default defineConfig({
  lint: {
    ...
    rules: {
      ...
      "devil/enforce-variant-standard": "error",
      "devil/no-deprecated-props": "error",
  ...
  pack: [
      ...
      exports: {
        ...
        customExports(exports: Record<string, unknown>) {
          ...
          return {
            ...
            "./styles/tailwind": "./dist/styles/devil.css",
            "./styles/standalone": "./dist/styles/devil-standalone.css",
            "./styles": "./dist/styles/devil.css",
    ...
    },
    {
      ...
      // The `(?!:)` guard stops Windows absolute paths (`F:\...`) from
      // matching: rolldown tests `external` against resolved ids too, and a
      // drive letter would otherwise look like a bare specifier — which
      // externalizes every relative dts import and breaks the bundle.
      deps: { neverBundle: /^[^./](?!:)/ },
