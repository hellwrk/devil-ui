...
const compact =
  "<main><table><thead><tr><th>Token</th><th>Use</th></tr></thead><tbody><tr><td><code>bg-devil-elevated</code></td><td>Slightly elevated surface</td></tr></tbody></table></main>";
...
describe("htmlToMarkdown table robustness", () => {
  ...
  it("renders block elements inside cells inline (MDX paragraph-wrapping)", () => {
    const withParagraphs =
      "<main><table><thead><tr><th>Token</th><th>Use</th></tr></thead><tbody><tr><td><code>bg-devil-elevated</code></td><td><p>Slightly elevated surface</p></td></tr></tbody></table></main>";
    const md = htmlToMarkdown(withParagraphs);
    expect(md).toContain("| `bg-devil-elevated` | Slightly elevated surface |");
  });
  ...
  it("produces identical valid tables from compact and formatted markup", () => {
    ...
    expect(b).toBe(a);
    expect(b).toContain("| `bg-devil-elevated` | Slightly elevated surface |");
  });
});
