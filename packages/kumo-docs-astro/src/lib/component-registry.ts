 ...
 * Reads from the auto-generated component-registry.json in the devil package.
 */

// Import the registry JSON from the devil package export
import registry from "@hellwrk/devil-ui/ai/component-registry.json";

// Import shared types from devil-ui
import type {
  ComponentRegistry,
  ComponentSchema,
  PropSchema,
