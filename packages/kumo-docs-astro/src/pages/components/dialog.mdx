...
<CodeBlock code={`import { Dialog } from "@hellwrk/devil-ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Dialog } from "@hellwrk/devil-ui/components/dialog";`}
    lang="tsx"
  />
</ComponentSection>
...
```tsx
import { Dialog, Button } from "@hellwrk/devil-ui";
...
<p>
  ...
  <div class="overflow-hidden rounded-lg border border-devil-hairline">
    <table class="w-full text-sm">
      ...
      <tbody class="divide-y divide-devil-hairline">
        <tr>
          <td class="px-4 py-3">
            `role="dialog"`
            <span class="ml-2 text-devil-subtle">(default)</span>
          </td>
          <td class="px-4 py-3">
...
<div class="mb-4 rounded-lg border border-devil-info/30 bg-devil-info/10 p-4 text-sm text-devil-info">
