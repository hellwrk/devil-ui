...
<CodeBlock code={`import { Checkbox } from "@hellwrk/devil-ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Checkbox } from "@hellwrk/devil-ui/components/checkbox";`}
    lang="tsx"
  />
</ComponentSection>
...
## Accessibility
  ...
  <div class="space-y-4 text-sm">
    ...
    <div>
      ...
      <p>
        <kbd class="rounded bg-devil-control px-1.5 py-0.5">Space</kbd> toggles
        the checkbox.
