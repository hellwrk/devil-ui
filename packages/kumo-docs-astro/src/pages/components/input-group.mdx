...
<CodeBlock code={`import { InputGroup } from "@hellwrk/devil-ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { InputGroup } from "@hellwrk/devil-ui/components/input-group";`}
    lang="tsx"
  />
</ComponentSection>
...
```tsx
import { InputGroup } from "@hellwrk/devil-ui";
