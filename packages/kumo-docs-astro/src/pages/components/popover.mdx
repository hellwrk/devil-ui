...
```tsx
import { Popover } from "@hellwrk/devil-ui";
```

### Granular

```tsx
import { Popover } from "@hellwrk/devil-ui/components/popover";
```
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="divide-y divide-devil-hairline">
        <tr>
          ...
          <td class="px-4 py-3 text-devil-subtle">
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-devil-subtle">Plain text only</td>
          <td class="px-4 py-3 text-devil-subtle">
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-devil-subtle">Hover or focus</td>
          <td class="px-4 py-3 text-devil-subtle">Click (default) or hover</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-devil-subtle">Not focusable</td>
          <td class="px-4 py-3 text-devil-subtle">
