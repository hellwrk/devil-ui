...
```bash
npx @hellwrk/devil-ui add DeleteResource
```
...
import { DeleteResource } from "./components/devil-ui/delete-resource/delete-resource";
```
...
import { DeleteResource } from "./components/devil-ui/delete-resource/delete-resource";
import { Button } from "@hellwrk/devil-ui";
