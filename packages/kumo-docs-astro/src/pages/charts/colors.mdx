...
Chart colors in devil-ui are split into three systems — **semantic** tokens for data with inherent
...
<div class="text-devil-info bg-devil-info-tint/50 rounded-lg py-1 px-4 ring ring-devil-info mb-12">
...
<div class="text-devil-info bg-devil-info-tint/50 rounded-lg py-1 px-4 ring ring-devil-info mb-6">
