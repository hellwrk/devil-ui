...
export function CopyPageButton({ align = "end" }: CopyPageButtonProps) {
  ...
  const getAIPromptUrl = (baseUrl: string) => {
    ...
    const prompt = encodeURIComponent(
      `Read through this devil-ui documentation: ${markdownUrl}. I'll need your help to understand it, so be prepared to explain concepts, share examples, and assist with debugging.`,
    );
