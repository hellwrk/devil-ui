...
import { Flow } from "@hellwrk/devil-ui";
...
>(function ExpandableNode({ title, children, ...props }, ref) {
  ...
  return (
    <li
      ref={ref}
      {...props}
      className="overflow-hidden rounded-lg bg-devil-base shadow ring ring-devil-hairline"
    >
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="flex w-full cursor-pointer items-center justify-between gap-2 px-3 py-2 text-sm font-medium text-devil-default"
      >
        {title}
        <CaretDownIcon
          className={`size-4 text-devil-subtle transition-transform ${open ? "rotate-180" : ""}`}
        />
      </button>
      {open && (
        <div className="border-t border-devil-hairline px-3 py-2 text-sm text-devil-subtle">
          {children}
        </div>
      )}
    </li>
...
export function FlowCustomContentDemo() {
  return (
    <Flow>
      <Flow.Node
        render={<li className="size-4 rounded-full bg-devil-hairline" />}
      />
      <Flow.Node
        render={
          <li className="rounded-lg bg-devil-contrast px-3 py-2 font-medium text-devil-inverse">
            my-worker
          </li>
        }
      />
...
export function FlowAnchorDemo() {
  return (
    <Flow>
      ...
      <Flow.Node
        render={
          <li className="rounded-lg bg-devil-overlay shadow-none ring ring-devil-hairline">
            <Flow.Anchor
              type="end"
              render={
                <div className="flex h-10 items-center px-2.5 text-devil-subtle">
                  my-worker
                </div>
              }
            />
            <Flow.Anchor
              type="start"
              render={
                <div className="m-1.5 mt-0 rounded bg-devil-base px-2 py-1.5 shadow ring ring-devil-hairline">
                  Bindings
                  <span className="ml-3 w-5 text-devil-subtle">2</span>
                </div>
              }
            />
          </li>
...
export function FlowCenteredDemo() {
  return (
    <Flow align="center">
      ...
      <Flow.Node
        render={
          <li className="rounded-md bg-devil-base px-3 py-6 shadow ring ring-devil-hairline">
            Taller node
          </li>
        }
      />
...
export function FlowPanningDemo() {
  return (
    <Flow className="rounded-lg border border-devil-hairline">
      <Flow.Node>Start</Flow.Node>
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <button
        ...
        className="rounded-md bg-devil-elevated px-3 py-1.5 text-sm font-medium text-devil-default ring ring-devil-line transition-colors hover:bg-devil-base"
      >
