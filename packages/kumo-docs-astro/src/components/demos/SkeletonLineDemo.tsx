import { SkeletonLine } from "@hellwrk/devil-ui";
...
function DemoWrapper({
  ...
  return (
    <div className="relative">
      <div className="absolute top-0 right-full bottom-0 mr-2 flex items-center border-r-2 border-devil-fill pr-2 text-sm">
        {label}
      </div>
      {children}
    </div>
...
export function SkeletonLineCardDemo() {
  return (
    <div className="w-64 rounded-lg p-4 ring ring-devil-hairline">
