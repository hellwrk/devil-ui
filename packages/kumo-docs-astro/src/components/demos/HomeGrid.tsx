...
function ToastTriggerButton() {
  const toastManager = useDevilToastManager();
  return (
    <Button
      onClick={() =>
        toastManager.add({
...
export function HomeGrid() {
      ...
      Component: (
        ...
        >
          ...
          <Collapsible.DefaultPanel>
            <Text>devil-ui is Cloudflare's component library.</Text>
          </Collapsible.DefaultPanel>
        </Collapsible.Root>
      ),
    },
  ...
  return a + b;
    ...
    },
    {
      ...
      id: "date-picker",
      Component: (
        <div className="scale-85 bg-devil-base p-4">
    ...
    },
    {
      ...
      Component: (
        <div className="flex items-center gap-1 text-sm">
          <span className="text-devil-subtle">Home</span>
          <span className="text-devil-inactive">/</span>
          <span className="text-devil-subtle">Docs</span>
          <span className="text-devil-inactive">/</span>
    ...
    },
    {
      name: "ClipboardText",
      id: "clipboard-text",
      Component: <ClipboardText text="npx devil add button" />,
    },
    {
      name: "CommandPalette",
      id: "command-palette",
    ...
    },
    {
      ...
      Component: (
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          <span className="text-xs text-devil-subtle">
    ...
    },
    {
      ...
      Component: (
        <Grid variant="side-by-side" gap="sm" className="w-[140px]">
          <GridItem className="rounded bg-devil-control p-3 text-center text-xs">
            1
          </GridItem>
          <GridItem className="rounded bg-devil-control p-3 text-center text-xs">
            2
  ...
  return (
    <ul className="grid auto-rows-min grid-cols-1 gap-px bg-devil-hairline md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
      {components.map((c) => {
        const route = componentRoutes[c.id] || null;
        return (
          <li
            className="relative flex aspect-square items-center justify-center bg-devil-canvas"
            key={c.name}
          >
            {route ? (
              <a
                href={route}
                className="absolute top-4 left-4 text-base font-medium text-devil-subtle hover:text-devil-default"
              >
                {c.name}
              </a>
            ) : (
              <span className="absolute top-4 left-4 text-base font-medium text-devil-subtle italic">
                {c.name}
              </span>
            )}
            <div className="flex w-full items-center justify-center p-8 leading-normal tracking-normal">
              {c.Component ?? (
                <p className="text-base font-medium text-devil-subtle">TBD</p>
              )}
            </div>
          </li>
        );
