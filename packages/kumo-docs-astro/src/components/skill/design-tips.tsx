import { Button, LayerCard, Text } from "@hellwrk/devil-ui";
import { CodeHighlighted } from "@hellwrk/devil-ui/code";
...
<Text as="strong" DANGEROUS_className="font-bold">required</Text>`,
  ...
  },
  {
    ...
    examples: [
      {
        variant: "good",
        exampleCode: `<button className="hover:bg-devil-tint">...</button>`,
        jsx: (
          <button
            type="button"
            className="cursor-pointer rounded-lg bg-devil-base px-4 py-2 font-medium ring ring-devil-line hover:bg-devil-tint"
          >
            Hover me
          </button>
        ),
      ...
      {
        variant: "bad",
        exampleCode: `<button className="transition-colors duration-300 hover:bg-devil-tint">...</button>`,
        jsx: (
          <button
            type="button"
            className="cursor-pointer rounded-lg bg-devil-base px-4 py-2 font-medium ring ring-devil-line transition-colors duration-300 hover:bg-devil-tint"
          >
            Hover me
          </button>
        ),
  ...
  },
  {
    ...
    description:
      "Use `ring ring-devil-line` to create a transparent border that maintains sharp edges.",
    examples: [
      {
        variant: "good",
        exampleCode: `<LayerCard className="shadow-md ring ring-devil-line">...</LayerCard>`,
        jsx: (
          <LayerCard className="w-full shadow-md ring ring-devil-line">
      ...
      {
        variant: "bad",
        exampleCode: `<LayerCard className="border border-devil-line shadow-md">...</LayerCard>`,
        jsx: (
          <LayerCard className="w-full border border-devil-line shadow-md ring-0">
  ...
  <div className="rounded-lg">...</div>
        ...
        jsx: (
          <div className="size-40 overflow-hidden">
            <div className="size-80 rounded-[48px] bg-devil-tint p-4 ring-2 ring-devil-line ring-inset">
              <div className="size-full rounded-4xl bg-devil-base ring-2 ring-devil-line ring-inset" />
            </div>
          </div>
        ),
      },
  ...
  <div className="rounded-xl">...</div>
        ...
        jsx: (
          <div className="size-40 overflow-hidden">
            <div className="size-80 rounded-[48px] bg-devil-tint p-4 ring-2 ring-devil-line ring-inset">
              <div className="size-full rounded-[48px] bg-devil-base ring-2 ring-devil-line ring-inset" />
            </div>
          </div>
        ),
      },
  ...
  },
  {
    ...
    examples: [
      {
        variant: "good",
        exampleCode: `<div className="sticky top-0 border-b border-devil-line">...</div>`,
        jsx: (
          <LayerCard className="h-56 w-full overflow-auto">
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-devil-line bg-devil-base px-3 py-2">
      ...
      },
      {
        ...
        jsx: (
          <LayerCard className="h-56 w-full overflow-auto">
            <div className="sticky top-0 z-10 flex items-center justify-between bg-devil-base px-3 py-2">
              <Text bold>API tokens</Text>
              <Button size="sm">Create</Button>
            </div>
            <div className="grid gap-4 p-3">
