...
import { CommandPalette, Badge, type HighlightRange } from "@hellwrk/devil-ui";
import {
  MagnifyingGlassIcon,
  CubeIcon,
  StackIcon,
...
const COMPONENTS_WITHOUT_DOCS = new Set([
  "Code", // Deprecated: use CodeHighlighted from devil-ui/code
  "CodeBlock", // Deprecated: use CodeHighlighted from devil-ui/code
...
/**
 * Chart components are auto-discovered from the devil-ui registry, but
...
const STATIC_PAGES: Array<{
  ...
  {
    name: "Installation",
    description: "How to install and set up devil-ui in your project.",
    url: "/installation",
    category: "Getting Started",
  },
  {
    name: "Contributing",
    description: "Guidelines for contributing to the devil-ui component library.",
    url: "/contributing",
    category: "Getting Started",
  },
  {
    name: "Accessibility",
    description:
      "Accessibility standards and best practices in devil-ui components.",
    url: "/accessibility",
    category: "Getting Started",
  },
  {
  ...
  {
    name: "Colors",
    description: "Explore devil-ui's semantic color tokens and theming system.",
    url: "/colors",
    category: "Guides",
  },
  {
  ...
  },
  {
    name: "CLI",
    description:
      "Use the Devil CLI to add components and blocks to your project.",
    url: "/cli",
    category: "Guides",
  },
  {
    name: "Streaming",
    description: "Server-side rendering and streaming support in devil-ui.",
    url: "/streaming",
    category: "Guides",
  },
  {
    name: "Figma",
    description: "Using devil-ui components in Figma with the Kumo Figma plugin.",
    url: "/figma",
    category: "Guides",
  },
  {
    name: "Component Registry",
    description: "Browse and explore the full devil-ui component registry.",
    url: "/registry",
    category: "Guides",
  },
  {
    name: "Landing",
    description: "Marketing landing page for devil-ui.",
    url: "/landing",
    category: "Getting Started",
  },
  {
      ...
      <CommandPalette.List>
        {loading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-devil-subtle">{error}</p>
          </div>
        ) : !hasResults ? (
                  ...
                  {(item: SearchItem) => (
                    ...
                    >
                      <div className="flex w-full items-center gap-3">
                        <div className="flex-shrink-0 text-devil-subtle">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <CommandPalette.HighlightedText
                              ...
                              className="text-base font-medium text-devil-default"
                            />
                          ...
                          <CommandPalette.HighlightedText
                            ...
                            className="block truncate text-sm text-devil-subtle"
                          />
                        </div>
                      </div>
                    </CommandPalette.Item>
      ...
      <CommandPalette.Footer>
        ...
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1">
            <kbd className="rounded border border-devil-hairline bg-devil-base px-1.5 py-0.5">
              ↑
            </kbd>
            <kbd className="rounded border border-devil-hairline bg-devil-base px-1.5 py-0.5">
              ↓
