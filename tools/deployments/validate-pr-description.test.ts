...
const WITH_DEVIL_CHANGE = '["packages/devil-ui/src/index.ts"]';
...
- [x] Tests included/updated
    ...
    it("fails when a Devil change is missing a changeset", () => {
      const body = `
- Reviews
- [x] bonk has reviewed the change
- Tests
- [x] Tests included/updated
    ...
    it("passes without a changeset when Devil is unchanged", () => {
      const body = `
- Reviews
- [x] bonk has reviewed the change
- Tests
