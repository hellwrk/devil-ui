...
export function validateDescription(
  ...
  const hasDevilChanges = changedFiles.some((f) =>
    f.startsWith("packages/devil-ui/"),
  );
  ...
  if (
    ...
    errors.push(
      "Your PR doesn't include a changeset. Either include one (following the instructions in CONTRIBUTING.md) or add the 'no-changeset-required' label to bypass this check. See https://github.com/hellwrk/devil-ui/blob/main/CONTRIBUTING.md#changesets for more details.",
    );
  }
