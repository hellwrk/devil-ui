...
Devil is an open-source project and we welcome contributions from you. Thank you!

Below you can find some guidance on how to be most effective when contributing to the project.

## tl;dr for contributing to Devil

Useful commands for developing Devil (all commands below should be run in the project root):

- `pnpm i; pnpm build` will build everything in devil.
...
- [Create your own fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) of [this repository](https://github.com/hellwrk/devil-ui).
- Clone your fork to your local machine

  ```sh
  git clone https://github.com/<your-github-username>/devil
  cd devil
  ```
  ...
  ```sh
  git remote -v
  origin	https://github.com/<your-github-username>/devil (fetch)
  origin	https://github.com/<your-github-username>/devil (push)
  ```

- Add `hellwrk/devil-ui` as the `upstream` remote repository.

  ```sh
  git remote add upstream https://github.com/hellwrk/devil-ui
  git remote -v
  origin	https://github.com/<your-github-username>/devil (fetch)
  origin	https://github.com/<your-github-username>/devil (push)
  upstream	https://github.com/hellwrk/devil-ui (fetch)
  upstream	https://github.com/hellwrk/devil-ui (push)
  ```
...
- You should regularly pull from the `main` branch of the `upstream` repository to keep up to date with the latest changes to the project.
  ...
  From https://github.com/hellwrk/devil-ui
...
If you find that you don't have write access, please reach out to your manager or the Devil team internally.

Clone the main repository:

```sh
git clone https://github.com/hellwrk/devil-ui.git
cd devil
```
...
This repository is setup as a [mono-repo](https://pnpm.io/workspaces) of workspaces. The workspaces are stored in the [`packages`](https://github.com/hellwrk/devil-ui/tree/main/packages) directory.
...
- The format for Pull Request titles is `[package name] description`, where the package name should indicate which package of the `devil` monorepo your PR pertains to (e.g. `devil`), and the description should be a succinct summary of the change you're making.
...
- When merging your PR into `main`, `devil` enforces squash merges. As such, please try and make sure that the commit message associated with the merge clearly describes the entire change your PR makes.
...
Every PR will have an associated pre-release build for all releasable packages within the repository, powered by [pkg.pr.new](https://github.com/stackblitz-labs/pkg.pr.new). You can find links to prereleases for each package in a comment automatically posted by GitHub Actions on each opened PR ([for example](https://github.com/hellwrk/devil-ui/pull/87#issuecomment-3908471698)).

## PR Tests

Every PR should include tests for the functionality that's being added. Most changes will be to [Devil](packages/devil-ui/src/) (using Vitest), and should include unit tests within the testing harness of those packages. For documentation on how these testing frameworks work, see:
...
When contributing to Devil, please refer to the [`STYLEGUIDE.md file`](STYLEGUIDE.md) file where possible to help maintain consistent patterns throughout Devil.

## Releases

We generally cut Devil releases on every weekday. If you need a release cut outside of the regular cadence, please reach out to the [devil-maintainers](https://github.com/orgs/cloudflare/teams/devil-maintainers) team.
